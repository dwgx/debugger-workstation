...
- Initialize: ask first (`templates/INIT_QUESTIONNAIRE.md` or `templates/i18n/<locale>/`), then `scripts/bootstrap.ps1` dry-run, then `-Apply`. Chat in the resolved locale (`docs/I18N.md`); git commits stay English. Read gitignored `OWNER.md` if present.
